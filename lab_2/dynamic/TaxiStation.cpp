...
namespace Records
{
  ...
  void TaxiStation::display()
  {
    ...
    cout << "Information about driver in TaxiStation: " << endl;
    cout << "First Name: " << firstName << " | Surname: " << lastName;
    cout << " | Hired: " << (fHired ? "Current Driver" : "Former Driver");
    cout << " | Driver Number: " << getDriverNumber();
